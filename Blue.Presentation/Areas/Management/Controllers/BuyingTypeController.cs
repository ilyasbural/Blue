namespace Blue.Presentation.Areas.Management.Controllers
{
	...
	public class BuyingTypeController : Controller
	{
		...
		[HttpPost]
		public async Task<IActionResult> Update([Bind(Prefix = "Item1")] BuyingTypeViewModel Model)
		{
			BuyingTypeUpdateDto BuyingType = new BuyingTypeUpdateDto();
			BuyingType.Id = Model.Id;
			BuyingType.Name = Model.Name;
			Response<BuyingType> Response = await Service.UpdateAsync(BuyingType);
			if (Response.Success > 0) return RedirectToAction("Index");
			else return View(Model);
		}
